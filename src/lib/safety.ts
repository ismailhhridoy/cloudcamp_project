...
const CRITICAL_PATTERNS: { keyword: string; tag: string }[] = [
  ...
  { keyword: "বুকে ব্যাথা", tag: "cardiac" },   // common phonetic variant of ব্যথা
  { keyword: "বুক ব্যথা", tag: "cardiac" },
  { keyword: "বুক ব্যাথা", tag: "cardiac" },
  ...
  { keyword: "শ্বাস কষ্ট", tag: "respiratory" },
  { keyword: "দম বন্ধ", tag: "respiratory" },
  ...
  { keyword: "তীব্র ব্যাথা", tag: "general" },
